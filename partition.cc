...
ullint *ClassInfo::TMPE = NULL;
ullint *ClassInfo::TMPM = NULL;
ullint *ClassInfo::TMPL = NULL;
...
ClassInfo::ClassInfo(char use_class, char *classf)
{
   ...
   TMPE = new ullint[NUMCLASS];
   TMPM = new ullint[NUMCLASS];
   TMPL = new ullint[NUMCLASS];
