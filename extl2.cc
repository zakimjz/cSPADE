...
void invdb::incr(int sz)
{
   ...
   if (numcust > 0 && (curit == NULL || curcnt == NULL || curitsz == NULL || curcid == NULL)){
...
//                if (outputfreq){
//                   cout << "YY " << F1::backidx[j] << " -1 " << F1::backidx[k]
//                        << " -2";
//                   for (i=0; i < NUMCLASS; i++)
//                      cout << " " << seq_sup[j][k][i];
//                   cout << " " << fcnt << endl;
